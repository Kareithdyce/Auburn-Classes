...
add wave -position end  sim:/aubie/aubie_ctl/ir_control
add wave -position end  sim:/aubie/aubie_ctl/behav/operand1
add wave -position end  sim:/aubie/aubie_ctl/behav/operand2
add wave -position end  sim:/aubie/aubie_ctl/behav/destination
add wave -position end  sim:/aubie/aubie_ctl/behav/opcode
add wave -position end  sim:/aubie/aubie_ctl/behav/state
